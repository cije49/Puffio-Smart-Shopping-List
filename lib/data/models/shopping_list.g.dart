...
ShoppingList _shoppingListDeserialize(
  ...
  object.lastOpenedAt = reader.readDateTimeOrNull(offsets[2]);
...
extension ShoppingListQuerySortBy
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> sortByIsArchived() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingListQuerySortThenBy
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> thenByIsArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isArchived', Sort.asc);
    });
  }
...
extension ShoppingListQueryWhereDistinct
  ...
  QueryBuilder<ShoppingList, ShoppingList, QDistinct> distinctByIsArchived() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingListQueryProperty
  ...
  QueryBuilder<ShoppingList, bool, QQueryOperations> isArchivedProperty() {
    return QueryBuilder.apply(this, (query) {
